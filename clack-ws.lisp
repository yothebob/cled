...
;; from https://lispcookbook.github.io/cl-cookbook/websockets.html
...
(defun chat-server (env)
  (let ((ws (websocket-driver:make-server env)))
    ...
    (websocket-driver:on :message ws
                         (lambda (msg)
			   (loop :for con :being :the :hash-value :of *connections* :do
			     (print con) ;;user-1234
			     ;; if a username in message, only broadcast it to that client
				 )
